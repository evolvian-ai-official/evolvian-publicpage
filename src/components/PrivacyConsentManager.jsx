...
const COPY = {
  ...
  es: {
    ...
    saleShareTitle: "Uso de herramientas publicitarias",
    saleShareBody: "Si activas esta opcion, limitamos el uso de herramientas publicitarias para respetar tu preferencia de privacidad.",
